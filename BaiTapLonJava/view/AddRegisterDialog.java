...
public class AddRegisterDialog extends javax.swing.JDialog implements ActionListener {
    ...
    public AddRegisterDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        //Phương thức initComponents() được gọi để khởi động và thiết lập giao diện người dùng
        setLocationRelativeTo(null);
        //setLocationRelativeTo(null) được sử dụng để đặt vị trí của các đối tượng cửa sổ ở giữa màn hình.
        addActionListener();
        subject = new Subject();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                //phương thức setVisible (true) được sử dụng để hiển thị hộp thoạitrên màn hình.
            }
        });
    }
    ...
    public void actionPerformed(ActionEvent e) {
        //Phương thức `actionPerformed` là một phương thức giao tiếp người dùng
        var obj = e.getSource();
